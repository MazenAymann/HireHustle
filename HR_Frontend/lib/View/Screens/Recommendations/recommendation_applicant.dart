...
import 'Technical_Info/technical_info.dart';

class RecommendedApplicantView extends StatelessWidget {
  RecommendedApplicantView(
      {super.key,
      required this.applicantIndex,
      required this.sortedApplicants});
    ...
    return Container(
      ...
      child: BlocConsumer<AppliedApplicantsCubit, AppliedApplicantsState>(
        listener: (context, state) {
          if (state is InterviewScheduled) {
        ...
        builder: (context, state) {
          return BlocBuilder<AppliedApplicantsCubit, AppliedApplicantsState>(
            builder: (context, state) {
              AppliedApplicantsCubit appliedApplicantsCubit =
                  BlocProvider.of(context);
              var applicant = sortedApplicants[applicantIndex];
                                      ...
                                      child: MaterialButton(
                                        onPressed: () => NavigationHelper
                                          ...
                                          PdfViewerPage(
                                            ...
                                            pdfUrl: applicant['cvPlaceholder'],
                                          ),
                                        ),
                                        highlightColor: Colors.transparent,
                                        splashColor: Colors.transparent,
                                  ...
                                  children: [
                                    Container(
                                      child: MaterialButton(
                                        onPressed: () {
                                          print(
                                              appliedApplicantsCubit.dateRange);
                                          if (appliedApplicantsCubit
                                              .dateRange.isEmpty) {
