  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: BlocProvider<ProfileCubit>(
        create: (context) => ProfileCubit(hr,context)..initializeAll(),
                  ...
                  children: [
                    Container(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundImage: hr['profileImage'] == '' || hr['profileImage'] == null
                            ? AssetImage(
                            'assets/images/main_profile_image.png')
                            : NetworkImage(hr['profileImage'])
                        as ImageProvider,
                      ),
                    ),
                    profileCubit.editable
                          ...
                          children: [
                            ...
                            ListView.separated(
                              itemBuilder: (context, index) =>
                                ...
                                focusedBorderWidth: 2.sp,
                                focusedBorderRadius: 10.sp,
                                controller: profileData[index+2]['controller'],
                                    enabled: profileCubit.editable
                              ),
